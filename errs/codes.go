...
const (
	...
	ErLoadDataInvalidColumnUnused                                         = 1611
	...
	ErCantChangeGTIDNextInTransaction                                     = 1768
	...
	ErAutoPositionRequiresGTIDModeNotOff                                  = 1777
	ErCantDoImplicitCommitInTrxWhenGTIDNextIsSet                          = 1778
	ErGTIDModeOnRequiresEnforceGTIDConsistencyOn                          = 1779
	...
	ErFoundGTIDEventWhenGTIDModeIsOffUnused                               = 1784
	...
	ErFileCorrupt                                                         = 3000
	ErErrorOnMaster                                                       = 3001
	ErInconsistentError                                                   = 3002
	ErStorageEngineNotLoaded                                              = 3003
	ErGetStackedDaWithoutActiveHandler                                    = 3004
	ErWarnLegacySyntaxConverted                                           = 3005
	ErBinlogUnsafeFulltextPlugin                                          = 3006
	ErCannotDiscardTemporaryTable                                         = 3007
	ErFkDepthExceeded                                                     = 3008
	ErColCountDoesntMatchPleaseUpdateV2                                   = 3009
	ErWarnTriggerDoesntHaveCreated                                        = 3010
	ErReferencedTrgDoesNotExist                                           = 3011
	ErExplainNotSupported                                                 = 3012
	ErInvalidFieldSize                                                    = 3013
	ErMissingHaCreateOption                                               = 3014
	ErEngineOutOfMemory                                                   = 3015
	ErPasswordExpireAnonymousUser                                         = 3016
	ErSlaveSQLThreadMustStop                                              = 3017
	ErNoFtMaterializedSubquery                                            = 3018
	ErInnodbUndoLogFull                                                   = 3019
	ErInvalidArgumentForLogarithm                                         = 3020
	ErSlaveChannelIoThreadMustStop                                        = 3021
	ErWarnOpenTempTablesMustBeZero                                        = 3022
	ErWarnOnlyMasterLogFileNoPos                                          = 3023
	ErQueryTimeout                                                        = 3024
	ErNonRoSelectDisableTimer                                             = 3025
	ErDupListEntry                                                        = 3026
	ErSQLModeNoEffect                                                     = 3027
	ErAggregateOrderForUnion                                              = 3028
	ErAggregateOrderNonAggQuery                                           = 3029
	ErSlaveWorkerStoppedPreviousThdError                                  = 3030
	ErDontSupportSlavePreserveCommitOrder                                 = 3031
	ErServerOfflineMode                                                   = 3032
	ErGisDifferentSrids                                                   = 3033
	ErGisUnsupportedArgument                                              = 3034
	ErGisUnknownError                                                     = 3035
	ErGisUnknownException                                                 = 3036
	ErGisInvalidData                                                      = 3037
	ErBoostGeometryEmptyInputException                                    = 3038
	ErBoostGeometryCentroidException                                      = 3039
	ErBoostGeometryOverlayInvalidInputException                           = 3040
	ErBoostGeometryTurnInfoException                                      = 3041
	ErBoostGeometrySelfIntersectionPointException                         = 3042
	ErBoostGeometryUnknownException                                       = 3043
	ErStdBadAllocError                                                    = 3044
	ErStdDomainError                                                      = 3045
	ErStdLengthError                                                      = 3046
	ErStdInvalidArgument                                                  = 3047
	ErStdOutOfRangeError                                                  = 3048
	ErStdOverflowError                                                    = 3049
	ErStdRangeError                                                       = 3050
	ErStdUnderflowError                                                   = 3051
	ErStdLogicError                                                       = 3052
	ErStdRuntimeError                                                     = 3053
	ErStdUnknownException                                                 = 3054
	ErGisDataWrongEndianess                                               = 3055
	ErChangeMasterPasswordLength                                          = 3056
	ErUserLockWrongName                                                   = 3057
	ErUserLockDeadlock                                                    = 3058
	ErReplaceInaccessibleRows                                             = 3059
	ErAlterOperationNotSupportedReasonGis                                 = 3060
	ErIllegalUserVar                                                      = 3061
	ErGTIDModeOff                                                         = 3062
	ErUnsupportedByReplicationThread                                      = 3063
	ErIncorrectType                                                       = 3064
	ErFieldInOrderNotSelect                                               = 3065
	ErAggregateInOrderNotSelect                                           = 3066
	ErInvalidRplWildTableFilterPattern                                    = 3067
	ErNetOkPacketTooLarge                                                 = 3068
	ErInvalidJSONData                                                     = 3069
	ErInvalidGeojsonMissingMember                                         = 3070
	ErInvalidGeojsonWrongType                                             = 3071
	ErInvalidGeojsonUnspecified                                           = 3072
	ErDimensionUnsupported                                                = 3073
	ErSlaveChannelDoesNotExist                                            = 3074
	ErSlaveMultipleChannelsHostPort                                       = 3075
	ErSlaveChannelNameInvalidOrTooLong                                    = 3076
	ErSlaveNewChannelWrongRepository                                      = 3077
	ErSlaveChannelDelete                                                  = 3078
	ErSlaveMultipleChannelsCmd                                            = 3079
	ErSlaveMaxChannelsExceeded                                            = 3080
	ErSlaveChannelMustStop                                                = 3081
	ErSlaveChannelNotRunning                                              = 3082
	ErSlaveChannelWasRunning                                              = 3083
	ErSlaveChannelWasNotRunning                                           = 3084
	ErSlaveChannelSQLThreadMustStop                                       = 3085
	ErSlaveChannelSQLSkipCounter                                          = 3086
	ErWrongFieldWithGroupV2                                               = 3087
	ErMixOfGroupFuncAndFieldsV2                                           = 3088
	ErWarnDeprecatedSysvarUpdate                                          = 3089
	ErWarnDeprecatedSqlmode                                               = 3090
	ErCannotLogPartialDropDatabaseWithGTID                                = 3091
	ErGroupReplicationConfiguration                                       = 3092
	ErGroupReplicationRunning                                             = 3093
	ErGroupReplicationApplierInitError                                    = 3094
	ErGroupReplicationStopApplierThreadTimeout                            = 3095
	ErGroupReplicationCommunicationLayerSessionError                      = 3096
	ErGroupReplicationCommunicationLayerJoinError                         = 3097
	ErBeforeDmlValidationError                                            = 3098
	ErPreventsVariableWithoutRbr                                          = 3099
	ErRunHookError                                                        = 3100
	ErTransactionRollbackDuringCommit                                     = 3101
	ErGeneratedColumnFunctionIsNotAllowed                                 = 3102
	ErUnsupportedAlterInplaceOnVirtualColumn                              = 3103
	ErWrongFkOptionForGeneratedColumn                                     = 3104
	ErNonDefaultValueForGeneratedColumn                                   = 3105
	ErUnsupportedActionOnGeneratedColumn                                  = 3106
	ErGeneratedColumnNonPrior                                             = 3107
	ErDependentByGeneratedColumn                                          = 3108
	ErGeneratedColumnRefAutoInc                                           = 3109
	ErFeatureNotAvailable                                                 = 3110
	ErCantSetGTIDMode                                                     = 3111
	ErCantUseAutoPositionWithGTIDModeOff                                  = 3112
	ErCantReplicateAnonymousWithAutoPosition                              = 3113
	ErCantReplicateAnonymousWithGTIDModeOn                                = 3114
	ErCantReplicateGTIDWithGTIDModeOff                                    = 3115
	ErCantSetEnforceGTIDConsistencyOnWithOngoingGTIDViolatingTransactions = 3116
	ErSetEnforceGTIDConsistencyWarnWithOngoingGTIDViolatingTransactions   = 3117
	ErAccountHasBeenLocked                                                = 3118
	ErWrongTablespaceName                                                 = 3119
	ErTablespaceIsNotEmpty                                                = 3120
	ErWrongFileName                                                       = 3121
	ErBoostGeometryInconsistentTurnsException                             = 3122
	ErWarnOptimizerHintSyntaxError                                        = 3123
	ErWarnBadMaxExecutionTime                                             = 3124
	ErWarnUnsupportedMaxExecutionTime                                     = 3125
	ErWarnConflictingHint                                                 = 3126
	ErWarnUnknownQbName                                                   = 3127
	ErUnresolvedHintName                                                  = 3128
	ErWarnOnModifyingGTIDExecutedTable                                    = 3129
	ErPluggableProtocolCommandNotSupported                                = 3130
	ErLockingServiceWrongName                                             = 3131
	ErLockingServiceDeadlock                                              = 3132
	ErLockingServiceTimeout                                               = 3133
	ErGisMaxPointsInGeometryOverflowed                                    = 3134
	ErSQLModeMerged                                                       = 3135
	ErVtokenPluginTokenMismatch                                           = 3136
	ErVtokenPluginTokenNotFound                                           = 3137
	ErCantSetVariableWhenOwningGTID                                       = 3138
	ErSlaveChannelOperationNotAllowed                                     = 3139
	ErInvalidJSONText                                                     = 3140
	ErInvalidJSONTextInParam                                              = 3141
	ErInvalidJSONBinaryData                                               = 3142
	ErInvalidJSONPath                                                     = 3143
	ErInvalidJSONCharset                                                  = 3144
	ErInvalidJSONCharsetInFunction                                        = 3145
	ErInvalidTypeForJSON                                                  = 3146
	ErInvalidCastToJSON                                                   = 3147
	ErInvalidJSONPathCharset                                              = 3148
	ErInvalidJSONPathWildcard                                             = 3149
	ErJSONValueTooBig                                                     = 3150
	ErJSONKeyTooBig                                                       = 3151
	ErJSONUsedAsKey                                                       = 3152
	ErJSONVacuousPath                                                     = 3153
	ErJSONBadOneOrAllArg                                                  = 3154
	ErNumericJSONValueOutOfRange                                          = 3155
	ErInvalidJSONValueForCast                                             = 3156
	ErJSONDocumentTooDeep                                                 = 3157
	ErJSONDocumentNullKey                                                 = 3158
	ErSecureTransportRequired                                             = 3159
	ErNoSecureTransportsConfigured                                        = 3160
	ErDisabledStorageEngine                                               = 3161
	ErUserDoesNotExist                                                    = 3162
	ErUserAlreadyExists                                                   = 3163
	ErAuditAPIAbort                                                       = 3164
	ErInvalidJSONPathArrayCell                                            = 3165
	ErBufpoolResizeInprogress                                             = 3166
	ErFeatureDisabledSeeDoc                                               = 3167
	ErServerIsntAvailable                                                 = 3168
	ErSessionWasKilled                                                    = 3169
	ErCapacityExceeded                                                    = 3170
	ErCapacityExceededInRangeOptimizer                                    = 3171
	ErTableNeedsUpgPart                                                   = 3172
	ErCantWaitForExecutedGTIDSetWhileOwningAGTID                          = 3173
	ErCannotAddForeignBaseColVirtual                                      = 3174
	ErCannotCreateVirtualIndexConstraint                                  = 3175
	ErErrorOnModifyingGTIDExecutedTable                                   = 3176
	ErLockRefusedByEngine                                                 = 3177
	ErUnsupportedAlterOnlineOnVirtualColumn                               = 3178
	ErMasterKeyRotationNotSupportedBySe                                   = 3179
	ErMasterKeyRotationErrorBySe                                          = 3180
	ErMasterKeyRotationBinlogFailed                                       = 3181
	ErMasterKeyRotationSeUnavailable                                      = 3182
	ErTablespaceCannotEncrypt                                             = 3183
	ErInvalidEncryptionOption                                             = 3184
	ErCannotFindKeyInKeyring                                              = 3185
	ErCapacityExceededInParser                                            = 3186
	ErUnsupportedAlterEncryptionInplace                                   = 3187
	ErKeyringUdfKeyringServiceError                                       = 3188
	ErUserColumnOldLength                                                 = 3189
	...
	ErXCmdArgumentTVale = 5017
	ErXBadUpsertData    = 5018
	...
	ErXCursorReachedEOF = 5123

	ErXPreparedStatementCanHaveOnCursor    = 5131
	ErXPreparedExecuteArgumentNotSupported = 5133
	ErXPreparedExecuteArgumentConsistency  = 5134
	...
	ErXMySQLXAaccountMissingPermissions = 5167
	ErXExpectFieldExistsFailed          = 5168
	ErXBadLocking                       = 5169
)
