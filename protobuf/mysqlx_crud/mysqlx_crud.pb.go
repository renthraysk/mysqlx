...
import (
	...
	mysqlx_expr "github.com/renthraysk/mysqlx/protobuf/mysqlx_expr"
...
const (
	ViewAlgorithm_UNDEFINED ViewAlgorithm = 1 // MySQL chooses which algorithm to use
	ViewAlgorithm_MERGE     ViewAlgorithm = 2 // the text of a statement that refers to the view and the view definition are merged
	ViewAlgorithm_TEMPTABLE ViewAlgorithm = 3 // the view are retrieved into a temporary table
)
...
const (
	ViewCheckOption_LOCAL    ViewCheckOption = 1 // the view WHERE clause is checked, but no underlying views are checked
	ViewCheckOption_CASCADED ViewCheckOption = 2 // the view WHERE clause is checked, then checking recurses to underlying views
)
...
const (
	UpdateOperation_SET          UpdateOperation_UpdateType = 1 // only allowed for TABLE
	UpdateOperation_ITEM_REMOVE  UpdateOperation_UpdateType = 2 // no value (removes the identified path from a object or array)
	UpdateOperation_ITEM_SET     UpdateOperation_UpdateType = 3 // sets the new value on the identified path
	UpdateOperation_ITEM_REPLACE UpdateOperation_UpdateType = 4 // replaces a value if the path exists
	UpdateOperation_ITEM_MERGE   UpdateOperation_UpdateType = 5 // source and value must be documents
	UpdateOperation_ARRAY_INSERT UpdateOperation_UpdateType = 6 // insert the value in the array at the index identified in the source path
	UpdateOperation_ARRAY_APPEND UpdateOperation_UpdateType = 7 // append the value on the array at the identified path
	UpdateOperation_MERGE_PATCH  UpdateOperation_UpdateType = 8 // merge JSON object value with the provided patch expression
)
...
const (
	Find_SHARED_LOCK    Find_RowLock = 1 // Lock matching rows against updates
	Find_EXCLUSIVE_LOCK Find_RowLock = 2 // Lock matching rows so no other transaction can read or write to it
)
...
const (
	Find_NOWAIT      Find_RowLockOptions = 1 // Do not wait to acquire row lock, fail with an error if a requested row is locked
	Find_SKIP_LOCKED Find_RowLockOptions = 2 // Do not wait to acquire a row lock, remove locked rows from the result set
)
...
func (x *Column) GetDocumentPath() []*mysqlx_expr.DocumentPathItem {
	if x != nil {
...
func (x *Projection) GetSource() *mysqlx_expr.Expr {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *LimitExpr) GetRowCount() *mysqlx_expr.Expr {
	if x != nil {
		return x.RowCount
	}
	return nil
...
func (x *LimitExpr) GetOffset() *mysqlx_expr.Expr {
	if x != nil {
		return x.Offset
	}
	return nil
...
func (x *Order) GetExpr() *mysqlx_expr.Expr {
	if x != nil {
		return x.Expr
	}
	return nil
...
func (x *UpdateOperation) GetSource() *mysqlx_expr.ColumnIdentifier {
	if x != nil {
		return x.Source
	}
	return nil
...
func (x *UpdateOperation) GetValue() *mysqlx_expr.Expr {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *Find) GetCriteria() *mysqlx_expr.Expr {
	if x != nil {
		return x.Criteria
	}
	return nil
...
func (x *Find) GetArgs() []*mysqlx_datatypes.Scalar {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *Find) GetGrouping() []*mysqlx_expr.Expr {
	if x != nil {
		return x.Grouping
	}
	return nil
...
func (x *Find) GetGroupingCriteria() *mysqlx_expr.Expr {
	if x != nil {
...
func (x *Insert) GetArgs() []*mysqlx_datatypes.Scalar {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *Update) GetCriteria() *mysqlx_expr.Expr {
	if x != nil {
		return x.Criteria
	}
	return nil
...
func (x *Update) GetArgs() []*mysqlx_datatypes.Scalar {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *Delete) GetCriteria() *mysqlx_expr.Expr {
	if x != nil {
		return x.Criteria
	}
	return nil
...
func (x *Delete) GetArgs() []*mysqlx_datatypes.Scalar {
	if x != nil {
		return x.Args
	}
	return nil
...
func (x *Insert_TypedRow) GetField() []*mysqlx_expr.Expr {
	if x != nil {
		return x.Field
	}
	return nil
...
var file_mysqlx_crud_proto_rawDesc = []byte{
	...
	,
	...
	0x2e, 0x4d, 0x79, 0x73, 0x71, 0x6c, 0x78, 0x2e, 0x45, 0x78, 0x70, 0x72, 0x2e, 0x45, 0x78, 0x70,
	0x72, 0x52, 0x08, 0x63, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x61, 0x12, 0x2c, 0x0a, 0x04, 0x61,
	...
	,
	...
	,
	...
	0x08, 0x43, 0x41, 0x53, 0x43, 0x41, 0x44, 0x45, 0x44, 0x10, 0x02, 0x42, 0x4c, 0x0a, 0x17, 0x63,
	0x6f, 0x6d, 0x2e, 0x6d, 0x79, 0x73, 0x71, 0x6c, 0x2e, 0x63, 0x6a, 0x2e, 0x78, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x5a, 0x31, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
	...
	0x73, 0x71, 0x6c, 0x78, 0x5f, 0x63, 0x72, 0x75, 0x64,
}
...
var file_mysqlx_crud_proto_goTypes = []interface{}{
	...
	(*mysqlx_expr.DocumentPathItem)(nil), // 23: Mysqlx.Expr.DocumentPathItem
	(*mysqlx_expr.Expr)(nil),             // 24: Mysqlx.Expr.Expr
	(*mysqlx_expr.ColumnIdentifier)(nil), // 25: Mysqlx.Expr.ColumnIdentifier
	(*mysqlx_datatypes.Scalar)(nil),      // 26: Mysqlx.Datatypes.Scalar
}
var file_mysqlx_crud_proto_depIdxs = []int32{
	...
	24, // 12: Mysqlx.Crud.Find.criteria:type_name -> Mysqlx.Expr.Expr
	26, // 13: Mysqlx.Crud.Find.args:type_name -> Mysqlx.Datatypes.Scalar
	13, // 14: Mysqlx.Crud.Find.order:type_name -> Mysqlx.Crud.Order
	24, // 15: Mysqlx.Crud.Find.grouping:type_name -> Mysqlx.Expr.Expr
	24, // 16: Mysqlx.Crud.Find.grouping_criteria:type_name -> Mysqlx.Expr.Expr
	6,  // 17: Mysqlx.Crud.Find.locking:type_name -> Mysqlx.Crud.Find.RowLock
	7,  // 18: Mysqlx.Crud.Find.locking_options:type_name -> Mysqlx.Crud.Find.RowLockOptions
	11, // 19: Mysqlx.Crud.Find.limit:type_name -> Mysqlx.Crud.Limit
	...
	26, // 29: Mysqlx.Crud.Update.args:type_name -> Mysqlx.Datatypes.Scalar
	...
	11, // 32: Mysqlx.Crud.Update.limit:type_name -> Mysqlx.Crud.Limit
	...
	26, // 37: Mysqlx.Crud.Delete.args:type_name -> Mysqlx.Datatypes.Scalar
	13, // 38: Mysqlx.Crud.Delete.order:type_name -> Mysqlx.Crud.Order
	11, // 39: Mysqlx.Crud.Delete.limit:type_name -> Mysqlx.Crud.Limit
