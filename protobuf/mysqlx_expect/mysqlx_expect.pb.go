...
func (Open_CtxOperation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4, []int{0, 0}
}
...
func (Open_Condition_Key) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4, []int{0, 0, 0}
}
...
func (Open_Condition_ConditionOperation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4, []int{0, 0, 1}
}
...
func (*Open) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4, []int{0}
}
...
func (*Close) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4, []int{1}
}
...
func init() { proto.RegisterFile("mysqlx_expect.proto", fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4) }

var fileDescriptor_mysqlx_expect_9a6a000f3a93fdd4 = []byte{
