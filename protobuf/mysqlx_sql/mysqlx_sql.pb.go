...
func (*StmtExecute) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_sql_6e0e02f135d62773, []int{0}
}
...
func (m *StmtExecute) XXX_Size() int {
	return xxx_messageInfo_StmtExecute.Size(m)
}
...
func (*StmtExecuteOk) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_sql_6e0e02f135d62773, []int{1}
}
...
func (m *StmtExecuteOk) XXX_Size() int {
	return xxx_messageInfo_StmtExecuteOk.Size(m)
}
...
func init() { proto.RegisterFile("mysqlx_sql.proto", fileDescriptor_mysqlx_sql_6e0e02f135d62773) }

var fileDescriptor_mysqlx_sql_6e0e02f135d62773 = []byte{
