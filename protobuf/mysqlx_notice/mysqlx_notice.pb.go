...
func (Frame_Scope) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{0, 0}
}
...
func (Frame_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{0, 1}
}
...
func (Warning_Level) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{1, 0}
}
...
func (SessionStateChanged_Parameter) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{3, 0}
}
...
func (GroupReplicationStateChanged_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{4, 0}
}
...
func (*Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{0}
}
...
func (*Warning) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{1}
}
...
func (*SessionVariableChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{2}
}
...
func (*SessionStateChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{3}
}
...
func (*GroupReplicationStateChanged) Descriptor() ([]byte, []int) {
	return fileDescriptor_mysqlx_notice_d515f5a077069ef3, []int{4}
}
...
func init() { proto.RegisterFile("mysqlx_notice.proto", fileDescriptor_mysqlx_notice_d515f5a077069ef3) }

var fileDescriptor_mysqlx_notice_d515f5a077069ef3 = []byte{
	// 722 bytes of a gzipped FileDescriptorProto
	,
}
